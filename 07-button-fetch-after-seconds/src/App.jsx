...
function App() {
  ...
  const onButtonClick = async () => {
    ...
    // activate loading state => so user will see the nice SPINNER
    setLoading(true)

    // load data 3 seconds after button click
    setTimeout(async () => {
      ...
      setTodos(todosApi);
      setLoading(false) // deactive loading spinner when the data is ready!
    }, 3000);
  };
